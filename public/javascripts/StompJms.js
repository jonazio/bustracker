...
function StompConnectionFactory(a){var b=this;
...
}function StompJms(){var M="",dc="\n-",ub='" for "gwt:onLoadErrorFn"',sb='" for "gwt:onPropertyErrorFn"',Sb='"<script src=\\"',fb='"><\/script>',W="#",cc=");",Wb="-\n",ec="-></scr",Tb='.cache.js\\"></scr" + "ipt>"',Y="/",ib="//",Jb="050392AABBCEFCE2AA0A86FE007ED1EE",Kb="257DDA1192D2ED679B96D5C43CA47631",Lb="29640DB7B79D0576B379D35B26988B9E",Mb="5A31A104E4E9DB8AF89F040327151494",Nb="97DEE1AEACAFB6017E7C2442FAA33E90",Pb=":",mb="::",Ub="<scr",eb='<script id="',pb="=",X="?",rb='Bad handler "',Gb="Cross-site hosted mode not yet implemented. See issue ",Qb="DOMContentLoaded",Ob="E5F22B74F7A81630136D1ABB77C72E49",gb="SCRIPT",N="StompJms",bb="StompJms.nocache.js",lb="StompJms::",db="__gwt_marker_StompJms",hb="base",_="baseUrl",Q="begin",P="bootstrap",$="clear.cache.gif",ob="content",bc="document.write(",V="end",Zb='evtGroup: "loadExternalRefs", millis:(new Date()).getTime(),',_b='evtGroup: "moduleStartup", millis:(new Date()).getTime(),',Db="gecko",Eb="gecko1_8",R="gwt.codesvr=",S="gwt.hosted=",T="gwt.hybrid",tb="gwt:onLoadErrorFn",qb="gwt:onPropertyErrorFn",nb="gwt:property",Hb="http://code.google.com/p/google-web-toolkit/issues/detail?id=2079",Cb="ie6",Bb="ie8",Ab="ie9",Z="img",fc="ipt>",Vb="ipt><!-",Rb="loadExternalRefs",jb="meta",Yb='moduleName:"StompJms", sessionId:window.__gwtStatsSessionId, subSystem:"startup",',U="moduleStartup",zb="msie",kb="name",wb="opera",yb="safari",ab="script",Ib="selectingPermutation",O="startup",$b='type: "end"});',ac='type: "moduleRequested"});',cb="undefined",Fb="unknown",vb="user.agent",xb="webkit",Xb="window.__gwtStatsEvent && window.__gwtStatsEvent({";
    ...
    StompJms.onScriptLoad=function(a){StompJms.onScriptLoad=null;
        q=a;
        B()
    };
    if(A()){alert(Gb+Hb);
